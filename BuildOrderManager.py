...
def tech_requirements_check(self: BotAI, step):
    can_build = False
    if step[2] == 'worker' or step[2] == 'structure':
        ...
        if self.structures(UnitTypeId[building_name]).ready:
            can_build = True
