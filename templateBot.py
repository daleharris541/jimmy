...
from debug import label_unit, draw_building_points, draw_expansions, get_direction_vector ,get_distance, calc_supply_depot_zones, calc_tech_building_zones
...
class Jimmy(BotAI):
    ...
    async def on_step(self, iteration: int):
        ...
        if self.debug:
            ...
            #draw_building_points(self, self.supply_depot_placement_list, green, ['depot'])
            #draw_building_points(self, self.tech_buildings_placement_list, red, self.building_list)
